/* This file will be compiled in conditionally if the function
 * gst_object_set_properties_from_uri_query_parameters is not found in the
 * upstream GStreamer Core libraries
 *
...
/**
 * @brief helper function to parse a uri, it parses it, and assigns all
 * the key-value pairs in the query to itself.
 *
 * gst_object_set_properties_from_uri_query_parameters:
 * @param obj: GObject to assign the key/value pairs to
 * @param uri: GstUri to parse the key/value pairs from
 *
 */
void
